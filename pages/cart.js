    ...
    <div className='w-full md:py-20'>
      <Wrapper>
          ...
          <div className='flex-[1]'>
            ...
            '>
              ...
              <div className='text-sm md:text-md py-5 border-t mt-5'>
                The subtotal reflects the total price of your order,inclding all duties
                and taxes,before any applicable discounts. It does not inclkuse delivery costs
                and international transaction fees.
              </div>

              {/* CHECKOUT BUTTON  */}
              <button className='w-full py-4 rounded-full bg-black text-white text-lg
              font-medium transition-transform active:scale-95 mb-0
              hover:opacity-75'>
                Checkout
              </button>
            </div>
        ...
        {/* <div className='flex-[2] flex flex-col items-center pb-[50px] md:mt-14'>
          ...
          <Link href='/' className='py-4 px-8 rounded-full bg-black text-white text-lg font-medium
